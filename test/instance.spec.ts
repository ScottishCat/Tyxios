import tyxios, { HttpRequestConfig, HttpResponseConfig } from '../src/index'
...
describe('instance', () => {
  ...
  test('should use instance options', () => {
    const instance = tyxios.create({ timeout: 1000 })
  ...
  test('should have defaults.headers', () => {
    const instance = tyxios.create({ baseURL: 'https://api.example.com' })
  ...
  test('should get the computed uri', () => {
    const fakeConfig: HttpRequestConfig = {
    ...
    expect(tyxios.getUri(fakeConfig)).toBe(
